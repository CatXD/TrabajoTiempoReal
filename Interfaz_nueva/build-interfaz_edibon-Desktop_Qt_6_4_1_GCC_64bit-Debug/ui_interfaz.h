...
public:
    ...
    void setupUi(QMainWindow *Interfaz)
    {
        ...
        botonParar->setObjectName("botonParar");
        QPalette palette;
        ...
        botonReanudar->setObjectName("botonReanudar");
        QPalette palette1;
        ...
        botonFinalizar->setObjectName("botonFinalizar");
        QPalette palette2;
        ...
        toggleModoControl->setObjectName("toggleModoControl");
        ...
        labelControlVel->setObjectName("labelControlVel");
        ...
        labelControlPos->setObjectName("labelControlPos");
        ...
        botonSetParametros->setObjectName("botonSetParametros");
        ...
        bSetPeriodo->setObjectName("bSetPeriodo");

        horizontalLayout_6->addWidget(bSetPeriodo);

        sbRepaintInterval = new QDoubleSpinBox(centralwidget);
        sbRepaintInterval->setObjectName("sbRepaintInterval");
        sbRepaintInterval->setDecimals(0);
        sbRepaintInterval->setMinimum(10.000000000000000);
        sbRepaintInterval->setMaximum(10000.000000000000000);
        sbRepaintInterval->setValue(500.000000000000000);
        ...
        labelRefVelPos->setObjectName("labelRefVelPos");
        ...
        dialRefVelPos->setObjectName("dialRefVelPos");
        ...
        dialRefVelPos->setNotchTarget(3.700000000000000);
        ...
        labelUnidadesVelPos->setObjectName("labelUnidadesVelPos");
        ...
        labelValueRefVelPos->setObjectName("labelValueRefVelPos");
        ...
        botonSetReferencia->setObjectName("botonSetReferencia");
        ...
        labelUnidadesVel->setObjectName("labelUnidadesVel");
        ...
        labelValueVel->setObjectName("labelValueVel");
        ...
        labelUnidadesPos->setObjectName("labelUnidadesPos");
        ...
        labelValuePos->setObjectName("labelValuePos");
        ...
        dVelocidad->setObjectName("dVelocidad");
        ...
        dPosicion->setObjectName("dPosicion");
        ...
        labelRangoVel->setObjectName("labelRangoVel");
        ...
        labelRangoPos->setObjectName("labelRangoPos");
        ...
        //QObject::connect(dialRefVelPos, &QDial::valueChanged, labelRefVelPos, &QLabel::setNum);
    ...
    {
        Interfaz->setWindowTitle(QCoreApplication::translate("Interfaz", "MainWindow", nullptr));
        botonParar->setText(QCoreApplication::translate("Interfaz", "PARAR", nullptr));
        botonReanudar->setText(QCoreApplication::translate("Interfaz", "REANUDAR", nullptr));
        botonFinalizar->setText(QCoreApplication::translate("Interfaz", "FINALIZAR", nullptr));
        toggleModoControl->setText(QCoreApplication::translate("Interfaz", "CVelocidad / CPosici\303\263n", nullptr));
        labelControlVel->setText(QCoreApplication::translate("Interfaz", "CONTROL VEL.", nullptr));
        labelControlPos->setText(QCoreApplication::translate("Interfaz", "CONTROL POS.", nullptr));
        labelKpVel->setText(QCoreApplication::translate("Interfaz", "Kp", nullptr));
        labelKiVel->setText(QCoreApplication::translate("Interfaz", "Ki", nullptr));
        labelKdVel->setText(QCoreApplication::translate("Interfaz", "Kd", nullptr));
        labelKpPos->setText(QCoreApplication::translate("Interfaz", "Kp", nullptr));
        labelKiPos->setText(QCoreApplication::translate("Interfaz", "Ki", nullptr));
        labelKdPos->setText(QCoreApplication::translate("Interfaz", "Kd", nullptr));
        botonSetParametros->setText(QCoreApplication::translate("Interfaz", "Modif. Param.", nullptr));
        bSetPeriodo->setText(QCoreApplication::translate("Interfaz", "Modif. T", nullptr));
        label_12->setText(QCoreApplication::translate("Interfaz", "ms", nullptr));
        label_9->setText(QCoreApplication::translate("Interfaz", "REFERENCIA VEL./POS.", nullptr));
        labelRefVelPos->setText(QCoreApplication::translate("Interfaz", "0rpm / 0\302\272", nullptr));
        labelUnidadesVelPos->setText(QCoreApplication::translate("Interfaz", "rpm/grados", nullptr));
        labelValueRefVelPos->setText(QCoreApplication::translate("Interfaz", "-46..42 rpm / 180\302\252", nullptr));
        botonSetReferencia->setText(QCoreApplication::translate("Interfaz", "Modif. Vel./Pos.", nullptr));
        labelUnidadesVel->setText(QCoreApplication::translate("Interfaz", "VELOCIDAD (rpm)", nullptr));
        labelValueVel->setText(QCoreApplication::translate("Interfaz", "0", nullptr));
        labelUnidadesPos->setText(QCoreApplication::translate("Interfaz", "POSICI\303\223N (\302\272)", nullptr));
        labelValuePos->setText(QCoreApplication::translate("Interfaz", "0", nullptr));
        labelRangoVel->setText(QCoreApplication::translate("Interfaz", "-45/45", nullptr));
        labelRangoPos->setText(QCoreApplication::translate("Interfaz", "-180/180", nullptr));
    } // retranslateUi
